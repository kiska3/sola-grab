...
LUA_SHA1 = get_hash(os.path.join(CWD, 'sola.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--warc-header', 'sola-dld-script-version: ' + VERSION,
...
project = Project(
    title='Sola.ai',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://www.archiveteam.org/images/a/a1/Sola.ai_logo.png" height="50px" title=""/>
        <h2>sola.ai <span class="links"><a href="https://sola.ai/">Website</a> &middot; <a href="https://tracker.archiveteam.org/sola/">Leaderboard</a></span></h2>
        <p>Archiving everything from sola.ai.</p>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://%s/%s' % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix='sola.ai'),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
